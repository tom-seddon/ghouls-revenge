...
FORF=0TO9:PRINTTAB(5,F*2+3)CHR$134;F+1"..."TAB(10,F*2+3)" "CHR$135:PROCPRNT(12,F*2+3,N$(F),6,1):PRINTTAB(29,F*2+3)CHR$131"...";HI(F):NEXT
IFSC=255GOTO{$L1320}
IFSC<>10PRINTTAB(7,SC*2+3)CHR$136
